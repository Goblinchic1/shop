...
<div class="product-card flex flex-col md:flex-row rounded-3xl bg-card">
    <a href="{{ route('product', ['product' => $item]) }}" class="product-card-photo overflow-hidden shrink-0 md:w-[260px] xl:w-[320px] h-[320px] md:h-full rounded-3xl">
    ...
    <div class="grow flex flex-col py-8 px-6 md:px-8">
        <h3 class="text-sm lg:text-md font-black"><a href="{{ route('product', ['product' => $item]) }}" class="inline-block text-white hover:text-pink">{{ $item->title }}</a></h3>
